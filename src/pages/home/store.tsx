...
export const dressCodeSection = {
  ...
  description: "Друзья, мы создаем атмосферу солнечной Италии и просим вас стать ее частью. Единая палитра поможет нам сделать этот день визуально незабываемым.",
  content: (
     <>
       <p>Только натуральный лен, шелк или хлопок.</p>

       <p><mark>Дамы</mark>: Платья миди/макси (кроме белого). Приветствуются акцентные украшения.</p>
       <p><mark>Мужчины</mark>: Светлые летние костюмы, рубашки без галстуков.</p>
